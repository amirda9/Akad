...
@section('meta')
    @include('components.meta',[
        'title' => getOption('site_information.website_name',config('settings.website_name')) .' | ' . 'ویرایش آدرس',
...
@endsection
@section('title')
    <title>{{ getOption('site_information.website_name',config('settings.website_name')) .' | ' . 'ویرایش آدرس' }}</title>
@endsection
        ...
        <div class="row">
            ...
            <div class="col-lg-9">
                ...
                <div class="bg-white p-4 rounded shadow-sm text-secondary">
                    ...
                    <hr/>
                    <form class="form-horizontal" method="POST" action="{{ route('user.addresses.update',$address) }}">
                        @csrf
                        @method('put')
                        <div class="row">
                            <div class="col-12 form-group">
                                ...
                                <input id="title" type="text" class="form-control" autocomplete="false"
                                       name="title" value="{{ old('title') ?: $address->title }}" required autofocus
                            ...
                            <div class="col-12 form-group">
                                ...
                                <textarea id="address" type="text" class="form-control"
                                          ...
                                          oninput="setCustomValidity('')"
                                          name="address">{{ old('address') ?: $address->address }}</textarea>
                            </div>
                            <div class="col-12 form-group">
                                <div class="custom-control custom-checkbox">
                                    <input {{ $address->is_default ? 'checked' : '' }} type="checkbox" name="is_default" class="custom-control-input" id="is_default">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <a id="btnBackToDashboard" class="btn btn-primary" href="{{ route('user.addresses.index') }}">بازگشت</a>
                            </div>
                        </div>
                    </form>

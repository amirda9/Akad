    ...
    <div class="content-wrapper">
        ...
        <div class="content">
            <div class="container-fluid">
                <div class="card">
                    <div class="card-body">
                        <form method="POST" action="{{ route('panel.menuItems.update', [$menu, $menuItem]) }}" enctype="multipart/form-data">
                            @csrf
                            @method('put')
                                ...
                                <div class="col-sm-5">
                                    <select class="form-control selectpicker {{ $errors->has('parent') ? 'is-invalid' : '' }}"
                                        ...
                                        @foreach($parents as $parent)
                                            <option class="level-{{ $parent->level }}" value="{{ $parent->id }}" {{ $parent->id == $menuItem->parent_id ? 'selected' : '' }}>{{ $parent->title }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="form-group row">
                                <div class="col-12 col-md-5 offset-md-4">
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" {{ $menuItem->new_page ? 'checked' : '' }} class="custom-control-input" name="new_page" id="new_page">

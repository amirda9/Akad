    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="d-flex flex-wrap justify-content-between align-items-center">
                ...
                <a class="btn btn-primary" href="{{ route('panel.productCategories.create') }}">افزودن دسته بندی</a>
            </div>
        </div>
    </div>
                                    ...
                                    @foreach ($categories as $category)
                                        <tr>
                                            ...
                                            <td class="p-2 text-right">
                                                <a class="btn btn-sm btn-light" href="{{ route('panel.productCategories.show',$category) }}">
                                                    مشاهده
                                                </a>
                                                <a class="btn btn-sm btn-primary" href="{{ route('panel.productCategories.edit',$category) }}">
                                                    ویرایش
                                                </a>

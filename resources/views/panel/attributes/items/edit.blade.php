    ...
    <div class="content-wrapper">
        ...
        <div class="content">
            <div class="container-fluid">
                <div class="card">
                    <div class="card-body">
                        <form method="POST" action="{{ route('panel.attributeItems.update',[$group, $attribute, $item]) }}" enctype="multipart/form-data">
                            @csrf
                            @method('put')
                            ...
                            <div class="row">
                                <div class="col-sm-5 offset-sm-4">
                                    ...
                                    <a class="btn btn-secondary" href="{{ route('panel.attributeItems.index',[$group,$attribute]) }}">
                                        بازگشت
                                    </a>
                                </div>
                            </div>

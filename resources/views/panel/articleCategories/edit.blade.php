...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-12">
                    <h1 class="m-0 text-dark"> مقالات ویرایش دسته بندی</h1>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="content">
        <div class="container-fluid">
            <div class="card">
                <div class="card-body">
                    <form method="POST" action="{{ route('panel.posts.categories.update', $category ) }}" enctype="multipart/form-data">
                        @csrf
                        @method('put')
                            ...
                            <div class="col-sm-5">
                                <select name="parent" data-placeholder='انتخاب دسته بندی والد' class="form-control selectpicker {{ $errors->has('parent') ? 'is-invalid' : '' }}" id="parent">
                                    ...
                                    @include('panel.articleCategories.childrenOptions',[
                                        ...
                                        'selected_categories' => [old('parent') ?: $category->parent_id]
                                    ])
                                </select>
                        ...
                        <div class="form-group row">
                            <label for="image" class="col-sm-4 text-sm-left col-form-label text-nowrap">تصویر جدید</label>
                            <div class="col-sm-5">
                        ...
                        <div class="form-group row">
                            <label for="icon" class="col-sm-4 text-sm-left col-form-label text-nowrap">آیکن جدید</label>
                            <div class="col-sm-5">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-5">
                                <input type="number" class="form-control {{ $errors->has('order') ? 'is-invalid' : '' }}" name="order" id="order" value="{{ old('order')?: $category->order }}"/>
                                @if ($errors->has('order'))
                                    <span class="invalid-feedback">
                        ...
                        <div class="row">
                            <div class="col-sm-5 offset-sm-4">
                                ...
                                <a class="btn btn-secondary" href="{{ route('panel.posts.categories.index') }}">بازگشت</a>
                            </div>
                        </div>
                    </form>
                </div>

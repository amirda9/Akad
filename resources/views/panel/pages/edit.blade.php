                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <textarea
                                            ...
                                            oninput="setCustomValidity('')"
                                            name="short_description">{!! old('short_description') ?: $page->short_description !!}</textarea>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <textarea
                                            ...
                                            oninput="setCustomValidity('')"
                                            name="full_description">{!! old('full_description') ?: $page->full_description !!}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        @if($page->image)
                                            <a class="btn btn-outline-danger btn-block"
                                               ...
                                               href="{{ route('panel.pages.deleteImage',$page) }}">
                                                حذف تصویر
                                            </a>
                                        @endif
                                    </div>
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <select class="form-control {{ $errors->has('published') ? 'is-invalid' : '' }}" name="published">
                                            <option value="1" {{ $page->published ? 'selected' : '' }}>منتشر شود</option>
                                            <option value="0" {{ $page->published ? '' : 'selected' }}>عدم انتشار</option>
                                        </select>
                                    </div>

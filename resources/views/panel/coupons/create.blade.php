    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="d-flex flex-wrap justify-content-between align-items-center">
                <h1 class="m-0 text-secondary">ایجاد کوپن تخفیف</h1>
        ...
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{route('panel.coupons.store')}}" method="post" enctype="multipart/form-data" >
                        @csrf
                        <div class="row">
                            <div class="form-group col-12 col-lg-6">
                                <label for="code">کد تخفیف</label>
                                <input type="text" id="code" name="code" placeholder="کد تخفیف" value="{{old('code')}}" class="form-control" >
                            </div>
                            <div class="form-group col-12 col-lg-6">
                                <label for="title">عنوان</label>
                            <input type="text" name="title" id="title" placeholder="عنوان" value="{{old('title')}}" class="form-control" >
                            </div>
                            <div class="form-group col-12 col-lg-6">
                            ...
                            <div class="form-group col-12 col-lg-6">
                                ...
                                <input type="text" name="amount" class="form-control" value="{{old('amount')}}" autocomplete="off" id="amount">
                            ...
                            <div class="form-group col-12 col-lg-6">
                                ...
                                <div class="input-group">
                                <input type="text" name="number" class="form-control" autocomplete="off" value="{{old('number')}}" id="number">
                                    <div class="input-group-prepend">
                            ...
                            <div class="form-group col-12 col-lg-6">
                                ...
                                <div class="input-group">
                                <input type="text" name="min_order_amount" class="form-control" value="{{old('min_order_amount')}}" autocomplete="off" id="min_order_amount">
                                    <div class="input-group-prepend">
                            ...
                            <div class="form-group col-12 col-lg-6">
                                ...
                                <div class="input-group">
                                    <input type="text" name="max_discount_amount" value="{{old('max_discount_amount')}}" class="form-control" autocomplete="off" id="max_discount_amount">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text">تومان/درصد</span>
                                    </div>
                                </div>
                            ...
                            <div class="form-group col-12 col-lg-6">
                                ...
                                <div class="input-group">
                                    <input type="text" name="shipping_discount" value="{{old('shipping_discount')}}" class="form-control" autocomplete="off" id="shipping_discount">
                                    <div class="input-group-prepend">
                            ...
                            <div class="col-12 col-lg-6">
                                <div class="row">
                                    <div class="form-group col-6">
                                        ...
                                        <input type="text" class="form-control"  autocomplete="off" id="start_date_picker">
                                    ...
                                    <div class="form-group col-6">
                                        ...
                                        <input type="text" class="form-control"  autocomplete="off" id="end_date_picker">
                            ...
                            <div class="form-group col-12">
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" name="general" class="custom-control-input" value="{{old('general')}}" id="general">
                            ...
                            <div class="form-group col-12">
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" name="is_disposable" class="custom-control-input" id="is_disposable">

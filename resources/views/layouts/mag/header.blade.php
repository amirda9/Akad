        ...
        <nav class="navbar navbar-expand-md navbar-light justify-content-between flex-nowrap p-0">
            ...
            @guest
                ...
                <div class="d-none d-lg-inline-block">
                    <a class="btn btn-outline-dark rounded-pill" href="{{ route('login') }}">
                        ورود / ثبت نام
                    </a>
                </div>
            @else
...
<div class="bg-dark shadow-sm position-sticky sticky-top" style="z-index: 1021">
    <div class="container-fluid px-lg-5 px-3">
        <div class="d-flex bg-dark flex-nowrap align-items-center position-relative">
